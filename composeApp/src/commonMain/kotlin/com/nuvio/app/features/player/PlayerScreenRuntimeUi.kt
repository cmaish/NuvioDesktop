...
internal fun PlayerScreenRuntime.RenderPlayerRuntimeUi() {
    ...
    val playerControlsState = PlayerControlsState(
        ...
        castLabel = stringResource(Res.string.compose_player_cast),
        castPanelTitle = stringResource(Res.string.compose_player_cast_panel_title),
        castSearchingLabel = stringResource(Res.string.compose_player_cast_searching),
        castNoDevicesLabel = stringResource(Res.string.compose_player_cast_no_devices),
        castConnectingLabel = stringResource(Res.string.compose_player_cast_connecting, "%s"),
        castConnectedLabel = stringResource(Res.string.compose_player_cast_connected, "%s"),
        castStopLabel = stringResource(Res.string.compose_player_cast_stop),
        castRefreshLabel = stringResource(Res.string.compose_player_cast_refresh),
