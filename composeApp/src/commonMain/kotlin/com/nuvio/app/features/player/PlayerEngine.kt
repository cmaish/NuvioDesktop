...
data class PlayerControlsState(
    ...
    val castPanelTitle: String = "Cast to device",
    val castSearchingLabel: String = "Searching for devices…",
    val castNoDevicesLabel: String = "No Cast devices found on this network",
    val castConnectingLabel: String = "Connecting to %s…",
    val castConnectedLabel: String = "Casting to %s",
    val castStopLabel: String = "Stop casting",
    val castRefreshLabel: String = "Refresh",
